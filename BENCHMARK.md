...
|---------|-----------|-------------|-------|-------|-----|---------|-----|-----|-----|-----|----------|
| S-1     | 50        | 10000       | 10000 | 0     | 1129.5 | 44.1ms | 44.0ms | 45.7ms | 46.6ms | 48.7ms | （填写） |
| S-2     | 200       | 50000       | 50000 | 0     | 4272.1 | 46.2ms | 45.6ms | 49.8ms | 51.1ms | 53.9ms | （填写） |
| S-3     | 500       | 100000      | 48200 | 51800 | 5027.4 | 47.0ms | 46.5ms | 50.4ms | 51.8ms | 55.8ms | （填写） |

> S-3 部分连接被拒绝（51800失败），单线程 Reactor 无法处理 500 并发连接。
...
```
单 Reactor:
- S-1: c=50,  QPS=1129.5, P99=48.7ms
- S-2: c=200, QPS=4272.1, P99=53.9ms
- S-3: c=500, QPS=5027.4, P99=55.8ms (30%连接失败)
